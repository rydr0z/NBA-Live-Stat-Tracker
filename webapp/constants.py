class WebAppParameters:
    ...
    CHALLENGE_CATS = ["pts", "ast"]
    CHALLENGE_NOW = True
    CHALLENGE_NAME = "Flash Challenge: Drive and Dish"
    CHALLENGE_DESC = "To earn the Challenge Reward, create a Challenge Entry featuring the top five players in scoring and the top five players in assists during the NBA games on Jan. 31, 2022."
